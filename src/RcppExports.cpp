...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< std::string >::type ArmaBreedSymbol(ArmaBreedSymbolSEXP);
    ...
    Rcpp::traits::input_parameter< char >::type symB(symBSEXP);
...
RcppExport SEXP optiSel_rcpp_segIBD(SEXP path1SEXP, SEXP path2SEXP, SEXP NFile1SEXP, SEXP NFile2SEXP, SEXP ArmaIndex1SEXP, SEXP ArmaIndex2SEXP, SEXP N1SEXP, SEXP N2SEXP, SEXP MSEXP, SEXP minSNPSEXP, SEXP minLSEXP, SEXP ArmacMSEXP, SEXP ArmakbSEXP, SEXP aSEXP, SEXP symBSEXP, SEXP skipSEXP, SEXP cskipSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< int >::type skip(skipSEXP);
    Rcpp::traits::input_parameter< int >::type cskip(cskipSEXP);
    rcpp_result_gen = Rcpp::wrap(rcpp_segIBD(path1, path2, NFile1, NFile2, ArmaIndex1, ArmaIndex2, N1, N2, M, minSNP, minL, ArmacM, Armakb, a, symB, skip, cskip));
    return rcpp_result_gen;
END_RCPP
}
// rcpp_segIBDandN
...
RcppExport SEXP optiSel_rcpp_segIBDandN(SEXP pathThisBreedSEXP, SEXP pathNativeSEXP, SEXP NFileCSEXP, SEXP NFileNSEXP, SEXP ArmaIndexCSEXP, SEXP ArmaIndexNSEXP, SEXP NCSEXP, SEXP MSEXP, SEXP minSNPSEXP, SEXP minLSEXP, SEXP ArmaPosSEXP, SEXP ArmakbSEXP, SEXP aSEXP, SEXP symBSEXP, SEXP skipSEXP, SEXP cskipSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::string >::type pathThisBreed(pathThisBreedSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type skip(skipSEXP);
    Rcpp::traits::input_parameter< int >::type cskip(cskipSEXP);
    rcpp_result_gen = Rcpp::wrap(rcpp_segIBDandN(pathThisBreed, pathNative, NFileC, NFileN, ArmaIndexC, ArmaIndexN, NC, M, minSNP, minL, ArmaPos, Armakb, a, symB, skip, cskip));
    return rcpp_result_gen;
END_RCPP
}
...
RcppExport SEXP optiSel_rcpp_segIBDandNVersion2(SEXP pathThisBreedSEXP, SEXP NFileCSEXP, SEXP NCSEXP, SEXP MSEXP, SEXP ArmaIndexCSEXP, SEXP ArmaNatSEXP, SEXP minSNPSEXP, SEXP minLSEXP, SEXP ArmaPosSEXP, SEXP ArmakbSEXP, SEXP aSEXP, SEXP symBSEXP, SEXP skipSEXP, SEXP cskipSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::string >::type pathThisBreed(pathThisBreedSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type skip(skipSEXP);
    Rcpp::traits::input_parameter< int >::type cskip(cskipSEXP);
    rcpp_result_gen = Rcpp::wrap(rcpp_segIBDandNVersion2(pathThisBreed, NFileC, NC, M, ArmaIndexC, ArmaNat, minSNP, minL, ArmaPos, Armakb, a, symB, skip, cskip));
    return rcpp_result_gen;
END_RCPP
}
// rcpp_segInbreeding
...
RcppExport SEXP optiSel_rcpp_segInbreeding(SEXP path1SEXP, SEXP path2SEXP, SEXP NFile1SEXP, SEXP NFile2SEXP, SEXP ArmaIndex1SEXP, SEXP ArmaIndex2SEXP, SEXP N1SEXP, SEXP N2SEXP, SEXP MSEXP, SEXP minSNPSEXP, SEXP minLSEXP, SEXP ArmacMSEXP, SEXP ArmakbSEXP, SEXP aSEXP, SEXP symBSEXP, SEXP skipSEXP, SEXP cskipSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::string >::type path1(path1SEXP);
    ...
    Rcpp::traits::input_parameter< int >::type skip(skipSEXP);
    Rcpp::traits::input_parameter< int >::type cskip(cskipSEXP);
    rcpp_result_gen = Rcpp::wrap(rcpp_segInbreeding(path1, path2, NFile1, NFile2, ArmaIndex1, ArmaIndex2, N1, N2, M, minSNP, minL, ArmacM, Armakb, a, symB, skip, cskip));
    return rcpp_result_gen;
END_RCPP
}
// rcpp_segN
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type M(MSEXP);
    Rcpp::traits::input_parameter< const arma::vec& >::type ArmaNkb(ArmaNkbSEXP);
    rcpp_result_gen = Rcpp::wrap(rcpp_segN(pathNative, NFileN, NC, ArmaIndexN, M, ArmaNkb));
    return rcpp_result_gen;
END_RCPP
}
