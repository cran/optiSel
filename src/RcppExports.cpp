...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(rcpp_completeness(Indiv, ArmanumSire, ArmanumDam, maxd));
    return __result;
END_RCPP
}
// rcpp_genecont
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(rcpp_genecont(numSire, numDam, numAnc, rNames, cNames));
    return __result;
END_RCPP
}
// rcpp_haplofreq
...
RcppExport SEXP optiSel_rcpp_haplofreq(SEXP pathThisBreedSEXP, SEXP pathRefBreedsSEXP, SEXP pathFreqSEXP, SEXP pathOrigSEXP, SEXP MarkerNameSEXP, SEXP stdBreedSymbolSEXP, SEXP ArmaIndexCSEXP, SEXP ArmaIndexRSEXP, SEXP NFileCSEXP, SEXP NFileRSEXP, SEXP NCSEXP, SEXP ArmaNRSEXP, SEXP MSEXP, SEXP minSNPSEXP, SEXP minLSEXP, SEXP ubFreqSEXP, SEXP ArmaPosSEXP, SEXP stdsymBSEXP, SEXP skipSEXP, SEXP cskipSEXP, SEXP getFreqSEXP, SEXP getOrigSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    ...
    __result = Rcpp::wrap(rcpp_haplofreq(pathThisBreed, pathRefBreeds, pathFreq, pathOrig, MarkerName, stdBreedSymbol, ArmaIndexC, ArmaIndexR, NFileC, NFileR, NC, ArmaNR, M, minSNP, minL, ubFreq, ArmaPos, stdsymB, skip, cskip, getFreq, getOrig));
    return __result;
END_RCPP
}
// rcpp_makeA_lowMem
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(rcpp_makeA_lowMem(numSire, numDam, AFounder, numFounder, IndivName, numKeep, ainKeep, anOff));
    return __result;
END_RCPP
}
// rcpp_makeA
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const arma::ivec& >::type numFounder(numFounderSEXP);
    Rcpp::traits::input_parameter< const Rcpp::CharacterVector >::type IndivName(IndivNameSEXP);
    __result = Rcpp::wrap(rcpp_makeA(numSire, numDam, AFounder, numFounder, IndivName));
    return __result;
END_RCPP
}
// rcpp_nativecont
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(rcpp_nativecont(pathNative, NFileN, NC, ArmaIndexN, M, ArmaNkb));
    return __result;
END_RCPP
}
// rcpp_segBreedComp
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(rcpp_segBreedComp(pathNative, Nfile, N, ArmaIndexN, MatChr, Armakb));
    return __result;
END_RCPP
}
// rcpp_segIBD
...
RcppExport SEXP optiSel_rcpp_segIBD(SEXP path1SEXP, SEXP path2SEXP, SEXP NFile1SEXP, SEXP NFile2SEXP, SEXP ArmaIndex1SEXP, SEXP ArmaIndex2SEXP, SEXP N1SEXP, SEXP N2SEXP, SEXP MSEXP, SEXP minSNPSEXP, SEXP minLSEXP, SEXP ArmacMSEXP, SEXP ArmakbSEXP, SEXP aSEXP, SEXP stdsymBSEXP, SEXP skipSEXP, SEXP cskipSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    ...
    Rcpp::traits::input_parameter< int >::type skip(skipSEXP);
    Rcpp::traits::input_parameter< int >::type cskip(cskipSEXP);
    __result = Rcpp::wrap(rcpp_segIBD(path1, path2, NFile1, NFile2, ArmaIndex1, ArmaIndex2, N1, N2, M, minSNP, minL, ArmacM, Armakb, a, stdsymB, skip, cskip));
    return __result;
END_RCPP
}
// rcpp_segIBDandN
...
RcppExport SEXP optiSel_rcpp_segIBDandN(SEXP pathThisBreedSEXP, SEXP pathNativeSEXP, SEXP NFileCSEXP, SEXP NFileNSEXP, SEXP ArmaIndexCSEXP, SEXP ArmaIndexNSEXP, SEXP NCSEXP, SEXP MSEXP, SEXP minSNPSEXP, SEXP minLSEXP, SEXP ArmaPosSEXP, SEXP ArmakbSEXP, SEXP aSEXP, SEXP stdsymBSEXP, SEXP skipSEXP, SEXP cskipSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< std::string >::type pathThisBreed(pathThisBreedSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type skip(skipSEXP);
    Rcpp::traits::input_parameter< int >::type cskip(cskipSEXP);
    __result = Rcpp::wrap(rcpp_segIBDandN(pathThisBreed, pathNative, NFileC, NFileN, ArmaIndexC, ArmaIndexN, NC, M, minSNP, minL, ArmaPos, Armakb, a, stdsymB, skip, cskip));
    return __result;
END_RCPP
}
...
RcppExport SEXP optiSel_rcpp_segIBDandNVersion2(SEXP pathThisBreedSEXP, SEXP NFileCSEXP, SEXP NCSEXP, SEXP MSEXP, SEXP ArmaIndexCSEXP, SEXP ArmaNatSEXP, SEXP minSNPSEXP, SEXP minLSEXP, SEXP ArmaPosSEXP, SEXP ArmakbSEXP, SEXP aSEXP, SEXP stdsymBSEXP, SEXP skipSEXP, SEXP cskipSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< std::string >::type pathThisBreed(pathThisBreedSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type skip(skipSEXP);
    Rcpp::traits::input_parameter< int >::type cskip(cskipSEXP);
    __result = Rcpp::wrap(rcpp_segIBDandNVersion2(pathThisBreed, NFileC, NC, M, ArmaIndexC, ArmaNat, minSNP, minL, ArmaPos, Armakb, a, stdsymB, skip, cskip));
    return __result;
END_RCPP
}
// rcpp_segInbreeding
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type skip(skipSEXP);
    Rcpp::traits::input_parameter< int >::type cskip(cskipSEXP);
    __result = Rcpp::wrap(rcpp_segInbreeding(path1, path2, NFile1, NFile2, ArmaIndex1, ArmaIndex2, N1, N2, M, minSNP, minL, ArmacM, Armakb, a, stdsymB, skip, cskip));
    return __result;
END_RCPP
}
// rcpp_segN
...
RcppExport SEXP optiSel_rcpp_segN(SEXP pathNativeSEXP, SEXP NFileNSEXP, SEXP NCSEXP, SEXP ArmaIndexNSEXP, SEXP MSEXP, SEXP ArmaNkbSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< std::string >::type pathNative(pathNativeSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type M(MSEXP);
    Rcpp::traits::input_parameter< const arma::vec& >::type ArmaNkb(ArmaNkbSEXP);
    __result = Rcpp::wrap(rcpp_segN(pathNative, NFileN, NC, ArmaIndexN, M, ArmaNkb));
    return __result;
END_RCPP
}
