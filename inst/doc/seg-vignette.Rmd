...
### Example Data Set
All evaluations are demonstrated at the example of cattle data contained in the package. Breed names, years of birth, simulated breeding values, and simulated sexes are provided in data frame `Cattle`.
