...
Data frame `Cattle` includes the phenotypic information and has columns `Indiv` (individual IDs), `Born` (year of birth), `Breed` (breed name), `BV`  (breeding values), and `Sex` (sexes). Sexes are recoded as 1 for males and 2 for females.
